 ...
 *
 * Unminified counterpart of altcha.min.js, shipped to satisfy the WordPress.org
 * requirement that compiled files travel with readable source.
 *
 * This is upstream's unminified build, downloaded verbatim from:
 *   https://unpkg.com/altcha@2.2.2/dist/altcha.js
 *
 * Note on format: altcha.min.js is upstream's UMD build (dist/altcha.umd.cjs);
 * this file is upstream's ESM build of the same 2.2.2 code. Upstream ships no
 * unminified UMD build, so these two differ in module wrapper only - verified by
 * string-literal comparison (236 of 238 literals shared; the 2 extra in the UMD
 * build, "exports" and "Module", are the UMD wrapper itself).
 *
 * ALTCHA is authored in Svelte/TypeScript and bundled, so identifiers here are
 * bundler-renamed. The true line-by-line source is the upstream repo above.
 *
 * This file is NOT enqueued - altcha.min.js is. Do not edit either by hand; to
 * refresh, re-download both from the pinned version above.
 */
