# Wbcom CAPTCHA Manager — UX Audit
...
For each template listed in your plugin's main file (or discoverable via `grep -r "template_include\|locate_template\|load_template" /Users/varundubey/Local Sites/wbcom-free/app/public/wp-content/plugins/buddypress-recaptcha`), verify:
...
|----------|------------------|----------|-------------|
| Admin Overview tab | /wp-login.php | Anonymous, Member, Admin | Desktop-L, Desktop-D, Mobile-L, Mobile-D |
| Admin Protection tab | /register/ | Member, Admin | Desktop-L, Desktop-D, Mobile-L, Mobile-D |
| Admin Advanced tab | /groups/create/ | Admin | Desktop-L, Desktop-D |
...
|-------------------|----------------------|------------------|-----------|--------|
| wbc/login-widget (CAPTCHA Login) | ☐ | ☐ | ☐ | ☐ |
...
For each plugin admin page (`admin.php?page=buddypress-recaptcha`):
...
- [ ] Merge tags resolve (qa220 not literal `qa220`)
