...
function wbc_get_option_compat( $option_name, $default = false ) {
	...
	if ( $value === null && strpos( $option_name, 'recaptcha' ) !== false ) {
	...
	if ( $value === null && strpos( $option_name, 'recapcha' ) !== false ) {
