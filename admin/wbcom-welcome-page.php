...
<div class="wbcom-tab-content">
	<div class="wbcom-welcome-main-wrapper">
		<div class="wbcom-welcome-head">
			<h2 class="wbcom-welcome-title"><?php esc_html_e( 'Wbcom Designs - reCaptcha', 'buddypress-recaptcha' ); ?></h2>
			...
			<p class="wbcom-welcome-description"><?php esc_html_e( 'This plugin provide to check reCaptcha in WP Login page, WP Registration, WP Lost Password, BuddyPress Registration, WooCommerce Login, WooCommerce Registration, WooCommerce Lost Password, WooCommerce Order Page, BBPress Topic And Replay pages', 'buddypress-recaptcha' ); ?></p>
