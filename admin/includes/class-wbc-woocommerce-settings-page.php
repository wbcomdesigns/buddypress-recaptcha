	...
	class Wbc_WooCommerce_Settings_Page {
		...
		public function get_sections() {
			...
			$sections = array(
				...
				'woo_review'         => __( 'Woo Product Review Form Captcha', 'buddypress-recaptcha' ),
					...
					$settings = apply_filters(
						...
						array(
							'section_title_recpacha_on_woo_review' => array(
								'name' => __( 'reCaptcha On Product Review Form', 'buddypress-recaptcha' ),
								'type' => 'title',
								'desc' => '',
								'id'   => 'wc_settings_tab_recapcha_woo_review',
							),
							'wbc_recapcha_enable_on_woo_review' => array(
								'name' => __( 'Enable reCaptcha on product review form', 'buddypress-recaptcha' ),
								'type' => 'checkbox',
